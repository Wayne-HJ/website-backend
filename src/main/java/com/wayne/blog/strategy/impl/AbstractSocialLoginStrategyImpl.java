...
import com.wayne.blog.dto.UserDetailDTO;
...
import com.wayne.blog.service.impl.UserDetailsServiceImpl;
import com.wayne.blog.strategy.SocialLoginStrategy;
...
public abstract class AbstractSocialLoginStrategyImpl implements SocialLoginStrategy {
    ...
    private UserDetailDTO saveUserDetail(SocialTokenDTO socialToken, String ipAddress, String ipSource) {
        ...
        UserAuth userAuth = UserAuth.builder()
                ...
                .lastLoginTime(LocalDateTime.now(ZoneId.of(ZoneEnum.SYDNEY.getZone())))
                .ipAddress(ipAddress)
                .ipSource(ipSource)
                .build();
