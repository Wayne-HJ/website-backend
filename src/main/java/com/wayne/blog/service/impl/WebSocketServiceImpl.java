...
import com.wayne.blog.dao.ChatRecordDao;
import com.wayne.blog.dto.ChatRecordDTO;
import com.wayne.blog.dto.RecallMessageDTO;
import com.wayne.blog.dto.WebsocketMessageDTO;
...
import com.wayne.blog.util.*;
import com.wayne.blog.vo.VoiceVO;
import com.wayne.blog.enums.ChatTypeEnum;
    ...
    public static class ChatConfigurator extends ServerEndpointConfig.Configurator {
        ...
        public void modifyHandshake(ServerEndpointConfig sec, HandshakeRequest request, HandshakeResponse response) {
            try {
                ...
                sec.getUserProperties().put(HEADER_NAME, "unknown-ip");
            }
        }
    }
