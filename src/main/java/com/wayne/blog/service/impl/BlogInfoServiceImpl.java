...
import com.wayne.blog.dao.*;
import com.wayne.blog.dto.*;
import com.wayne.blog.entity.Article;
import com.wayne.blog.entity.WebsiteConfig;
...
import com.wayne.blog.util.IpUtils;
import com.wayne.blog.vo.BlogInfoVO;
import com.wayne.blog.vo.PageVO;
import com.wayne.blog.vo.WebsiteConfigVO;
import com.wayne.blog.dao.*;
import com.wayne.blog.dto.*;
...
public class BlogInfoServiceImpl implements BlogInfoService {
    ...
    public String getAbout() {
        ...
        if (Objects.nonNull(value)) {
            ...
            // 从数据库中加载
            about = websiteConfigDao.selectById(DEFAULT_ABOUT).getConfig();
            //about = JSON.parseObject(config, WebsiteConfigVO.class);
    ...
    public void updateAbout(BlogInfoVO blogInfoVO) {
        ...
        WebsiteConfig websiteConfig = WebsiteConfig.builder()
                .id(2)
                .config(blogInfoVO.getAboutContent())
                .build();
        websiteConfigDao.updateById(websiteConfig);
        //websiteConfigDao.updateById(websiteConfig);
        // 删除缓存
