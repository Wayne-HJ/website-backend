...
import com.wayne.blog.dao.UserInfoDao;
import com.wayne.blog.dao.UserRoleDao;
import com.wayne.blog.dto.*;
...
import com.wayne.blog.enums.LoginTypeEnum;
import com.wayne.blog.enums.RoleEnum;
import com.wayne.blog.exception.BizException;
import com.wayne.blog.service.BlogInfoService;
import com.wayne.blog.service.RedisService;
import com.wayne.blog.service.UserAuthService;
import com.baomidou.mybatisplus.extension.service.impl.ServiceImpl;
import com.wayne.blog.strategy.context.SocialLoginStrategyContext;
import com.wayne.blog.util.PageUtils;
import com.wayne.blog.util.UserUtils;
import com.wayne.blog.vo.*;
import com.wayne.blog.dto.EmailDTO;
import com.wayne.blog.dto.UserAreaDTO;
import com.wayne.blog.dto.UserBackDTO;
import com.wayne.blog.dto.UserInfoDTO;
import com.wayne.blog.enums.UserAreaTypeEnum;
import com.wayne.blog.util.CommonUtils;
import com.wayne.blog.vo.*;
...
import static com.wayne.blog.constant.CommonConst.*;
import static com.wayne.blog.constant.MQPrefixConst.EMAIL_EXCHANGE;
import static com.wayne.blog.constant.RedisPrefixConst.*;
                ...
                .map(item -> {
                    if (StringUtils.isNotBlank(item.getIpSource())) {
                        return item.getIpSource()
                                .substring(0, item.getIpSource().indexOf(","));
                                //.replaceAll(PROVINCE, "")
                                //.replaceAll(CITY, "");
                    }
                    return UNKNOWN;
