...
import com.wayne.blog.dao.MenuDao;
import com.wayne.blog.dao.RoleMenuDao;
import com.wayne.blog.dto.MenuDTO;
import com.wayne.blog.dto.LabelOptionDTO;
import com.wayne.blog.dto.UserMenuDTO;
import com.wayne.blog.entity.Menu;
import com.wayne.blog.entity.RoleMenu;
import com.wayne.blog.exception.BizException;
import com.wayne.blog.service.MenuService;
import com.wayne.blog.util.BeanCopyUtils;
import com.wayne.blog.util.UserUtils;
import com.wayne.blog.vo.ConditionVO;
import com.wayne.blog.vo.MenuVO;
        ...
        return catalogList.stream().map(item -> {
            ...
            if (CollectionUtils.isNotEmpty(children)) {
                ...
                list.add(UserMenuDTO.builder()
                        .path("").tempName(item.getTempName())
                        .name(item.getName())
                        .icon(item.getIcon())
